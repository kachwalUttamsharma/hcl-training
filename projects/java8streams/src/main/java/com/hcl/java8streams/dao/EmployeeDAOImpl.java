...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	@Override
	public List<Employee> getEmployee(String empname, char bandname,String salary) {
    ...
    if(bandname != ' '){
    	...
    	list = list.stream().filter((a)->a.getSalary()>=Integer.parseInt(salary)).collect(Collectors.toList());
    }
		return list;
	}
