...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.hcl.web.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.12:8081/SOAPWebServiceCalculator/services/Calculator";
    ...
    public com.hcl.web.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.hcl.web.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.web.CalculatorSoapBindingStub _stub = new com.hcl.web.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.web.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.web.CalculatorSoapBindingStub _stub = new com.hcl.web.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.hcl.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.hcl.com", "Calculator"));
        }
