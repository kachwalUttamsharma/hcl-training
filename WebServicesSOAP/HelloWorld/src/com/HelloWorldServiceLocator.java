...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://192.168.1.102:8686/Hello";
    ...
    public com.HelloWorld getHelloWorldPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.HelloWorldPortBindingStub _stub = new com.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.HelloWorldPortBindingStub _stub = new com.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com/", "HelloWorldPort"));
        }
